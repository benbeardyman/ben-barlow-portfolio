...
const About = () => {
    ...
    return (
        <div id="about" className='flex flex-col items-center justify-center min-h-screen w-screen relative'>
            <div className='flex flex-col flex-wrap justify-center items-center min-h-50 w-10/12 lg:w-3/4 bg-clotted-cream border-2 md:border-4 border-coral rounded-3xl mb-2 xs:mb-4 md:mb-10'>
                <h3 className="pt-2 md:pt-4 px-16 text-center font-header text-lg md:text-xl">
                    About Me
                </h3>

                <div className="flex flex-col items-center md:flex-row md:items-start">
                    <img src={pixelMug} alt="pixelated profile" className='border-2 md:border-4 border-black rounded-full h-12 w-12 xs:h-16 xs:w-16 md:h-40 md:w-40 mt-1 md:mt-4 md:ml-4 lg:ml-8'/>
                    <div className='flex flex-col pt-2 md:pt-4 mb-2 md:mb-4'>
                        <p className='px-4 lg:px-16 text-left font-header text-sm xs:text-sm md:text-lg'>
                            I am a naturally inquisitive newly qualified Software Developer with extensive experience in retail and hospitality. 
                        </p>
                        <p className='pt-1 md:pt-4 px-4 lg:px-16 text-left font-primary text-xs xs:text-sm  md:text-base'>
            ...
            <div className='flex flex-col flex-wrap justify-center items-center min-h-50 w-10/12 lg:w-3/4 bg-clotted-cream border-2 md:border-4 border-coral rounded-3xl'>
                ...
                <p className='px-4 md:px-16 text-center font-primary text-xs xs:text-sm md:text-base'>
                    November 2022 - March 2023
                </p>
                <p className='pt-1 md:pt-4 px-4 lg:px-16 font-primary text-xs xs:text-sm md:text-base text-center'>
